...
HEAD_DIR = $(BSP_BASE)/include
DRIVER_DIR = $(BSP_BASE)/drivers
ENV_DIR = $(BSP_BASE)/env
STUB_DIR = $(BSP_BASE)/stubs
...
CLEAN_OBJS += $(TARGET) $(LINK_OBJS) $(DUMP_OBJS) $(VERILOG_OBJS) $(HEX_OBJS) $(TARGET).dump $(TARGET).verilog $(TARGET).bin $(TARGET).hex
...
dasm: $(TARGET).dump $(TARGET).verilog $(TARGET).bin $(TARGET).hex
